  ...
  <b-overlay :show="RecievedData === null" rounded="sm">
    ...
    >
      <div v-if="SelectedPost" class="row">
        <div class="col-md-12">
          <img v-if="SelectedPost.medias.length>0" style="width: 100%;height: 400px;object-fit: contain" :src="`https://banooclubapi.oregonserver.com/media/gallery/post/${SelectedPost.medias[0].base64}`" alt="">
        </div>

...
<script>
import {GetAdsByUserId} from "@/libs/Api/Users/UserMethods";
...
export default {
  ...
  methods:{
    async GetForumByUserId(){
      ...
      let _this = this
      let  getAdsByUserId = new GetAdsByUserId()
      let data = {
        userId:this.userId,
        count:this.perPage,
        pageNumber:this.currentPage
      }
      getAdsByUserId.setParams(data)
      await getAdsByUserId.fetch((content)=>{
        _this.RecievedData  = content.ads

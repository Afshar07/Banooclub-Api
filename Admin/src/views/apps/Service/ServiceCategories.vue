        ...
        <b-row v-if="SelectedCategory!==null">
          ...
          <b-col md="12">
            ...
            <div class="position-relative" v-if="SelectedCategory.fileData!==''">
              ...
              <img v-if="BaseImgUrl===''" :src="`https://api.banooclub.simagar.com/media/gallery/serviceCategory/${SelectedCategory.fileData}`" width="100px" height="100px" alt="">
      ...
      >
        ...
        >
          ...
          <template #cell(fileData)="data">
            ...
            <img v-if="data.item.fileData" :src="`https://api.banooclub.simagar.com/media/gallery/serviceCategory/${data.item.fileData}`" width="50px" height="50px" alt="">

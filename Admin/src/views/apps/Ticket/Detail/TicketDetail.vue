        ...
        >
            ...
            <header class="chat-header">
              ...
              <div class="d-flex align-items-center">
                <b-avatar
                    ...
                    size="36"
                    :src="`https://banooclubapi.oregonserver.com/${Tickets[0].userInfo.selfieFileData}`"
          ...
          >
            <chat-log
                ...
                :chat-data="Ticket"
                :profile-user-avatar="`https://banooclubapi.oregonserver.com/${Tickets[0].userInfo.selfieFileData}`"
                :admin="admin"
                :user="user"
            />
          </vue-perfect-scrollbar>

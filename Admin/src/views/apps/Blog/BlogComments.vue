              ...
              <div v-for="(item,idx) in AllComments" :key="idx" class="col-lg-3 col-md-6 my-1">
                <div class="d-flex flex-lg-row flex-md-column align-items-center justify-content-between   gap-2  BoxShadow p-3"  style="border-radius: 15px">
                  <div class="d-flex align-items-center">
                    <img class="mx-2 rounded-circle shadow" v-if="item.userInfo && item.userInfo.displayName!==null" :src="'https://banooclubapi.oregonserver.com/media/gallery/Profile/' + item.userInfo.selfieFileData" alt="Comment" width="40px" height="40px">

      ...
      <b-col cols="12" class="mx-auto">
        ...
        >
          ...
          <template #cell(medias)="data">
            ...
            <img v-if=" data.item.medias && data.item.medias.length>0" :src="`https://api.banooclub.simagar.com/media/gallery/post/${data.item.medias[0].base64}`" style="object-fit: contain;object-position: center" width="50px" height="50px" alt="">

...
<!--        :src="chatData.userInfo.userId === formattedChatData.contact.id ? formattedChatData.contact.avatar : profileUserAvatar"-->
      ...
      <div class="chat-body">
        <div class="chat-content position-relative " :class="{'pb-2': chatData.userInfo.userId === admin.userId}">
          ...
          <img v-if="chatData.fileData!==''" :src="`https://banooclubapi.simagar.com/${chatData.fileData}`" style="object-fit: contain;object-position: center" class="my-2" width="200px" height="100px" alt="">
        </div>
      </div>
    </div>
  </div>

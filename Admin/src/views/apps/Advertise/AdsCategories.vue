    ...
    <div v-if="Categories !== null">
      ...
      >
        ...
        <div class="position-relative" v-if=" SelectedCategory!==null&&SelectedCategory.fileData!==null">
          <img v-if="BaseImgUrl===''" :src="`https://banoclubapi.com/media/gallery/adsCategory/${SelectedCategory.fileData}`" width="100px" height="100px" alt="">
      ...
      >
        ...
        >
          ...
          <template #cell(fileData)="data">
            ...
            <img :src="`https://banoclubapi.com/media/gallery/adsCategory/${data.item.fileData}`" width="50px" height="50px" alt="">
          </template>

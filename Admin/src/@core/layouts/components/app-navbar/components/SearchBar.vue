        ...
        <ul>
          ...
          >
            <div class=" d-flex align-items-center ">
              <img v-if="item.selfieFileData" class="rounded-circle" style="width: 50px;height: 50px" :src="`https://banooclubapi.oregonserver.com/media/gallery/profile/${item.selfieFileData}`" alt="">

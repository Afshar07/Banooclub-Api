...
namespace BanooClub.Services.MessageRecipientServices
{
    public class MessageRecipientService : IMessageRecipientService
    {
        ...
        public MessageRecipientService(IBanooClubEFRepository<MessageRecipient> messageRecipientRepository)
        {

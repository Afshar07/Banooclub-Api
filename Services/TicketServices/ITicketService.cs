...
namespace BanooClub.Services.TicketServices
{
    public interface ITicketService
    {
        ...
        IServiceResult<object> GetAll(int pageNumber, int count, string searchCommand, byte ticketType);
        ...
        IServiceResult<bool> ChangeTicketType(long parentId, byte ticketType);
    }
}

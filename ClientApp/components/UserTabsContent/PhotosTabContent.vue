      ...
      <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
          ...
          <div v-if="SelectedMedia!==null" class="modal-body">
            <img v-if="SelectedMedia.priority == 1 || SelectedMedia.priority == 2" class="tw-w-full tw-h-full" :src="`https://api.banooclub.simagar.com/media/gallery/galleryimages/${SelectedMedia.base64}`" alt="Product Image"
            ...
            <video
              ...
              controls
              :src="`https://api.banooclub.simagar.com/media/gallery/galleryvideos/${SelectedMedia.base64}`"
            ></video>
          </div>
...
<!--            <a href="#offcanvasExampleeee" data-bs-toggle="offcanvas">-->
            <button  v-if="item.priority === 1 || item.priority === 2" class="btn tw-w-full tw-h-full ShowMediaModal"    style="object-fit: contain;object-position: center !important;height: 330px;!important; ">
              ...
              <img data-bs-toggle="modal" data-bs-target="#MediaModal"  @click="SetSelectedMedia(item)" class="tw-w-full tw-shadow tw-rounded tw-h-full" :src="`https://api.banooclub.simagar.com/media/gallery/galleryimages/${item.base64}`"  style="object-fit: contain;object-position: center !important;height: 330px;!important; ">
            </button>
            <button  v-else-if="item.priority === 3" class="btn ShowMediaModal w-100 tw-h-full"   >
              ...
              <video
                ...
                controls
                :src="`https://api.banooclub.simagar.com/media/gallery/galleryvideos/${item.base64}`"
              ></video>
            </button>

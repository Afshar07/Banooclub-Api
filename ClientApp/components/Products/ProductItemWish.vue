  ...
  <div class="card" v-if="service_details.serviceInfo" >
    <div class="card-media tw-h-40">
      ...
      <nuxt-link :to="`/Products/${service_details.serviceInfo.servicePackId}`">
        <img v-if="service_details.serviceInfo && service_details.serviceInfo.medias!==null" :src="`https://subapi.banoclub.com/media/gallery/service/${service_details.serviceInfo.medias[0].base64}`"  alt="">

  ...
  <div class="card" v-if="service_details.serviceInfo" >
    <div class="card-media tw-h-40">
      ...
      <nuxt-link :to="`/Products/${service_details.serviceInfo.servicePackId}`">
        <img v-if="service_details.serviceInfo && service_details.serviceInfo.medias!==null" :src="`https://api.banooclub.simagar.com/media/gallery/service/${service_details.serviceInfo.medias[0].base64}`"  alt="">
    ...
    <div  class="card-body p-2 ">
      ...
      <div class="tw-flex tw-items-center  tw-left-2  tw-justify-center position-absolute tw-top-[-15px]">
        ...
        <div class="tw-top-3 ShadowPrice  tw-border-1  tw-rounded tw-shadow tw-bg-[#9cf5ff]  tw-font-medium tw-px-2 tw-py-1 tw-left-2  tw-text-[#db3cd6]">

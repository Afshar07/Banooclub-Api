  ...
  <div class="m-0 p-0 row col-12 bg-white header_in_add_post" style="border: 1px solid #ebe9e6;border-radius: 1rem;height: 450px">
    <div class="m-0 p-0 row col-12">
      <div class="m-0 p-0 row col-md-12 mb-md-4 d-md-block" :class="isChatLayout ? 'd-none' : 'd-block'">
        <div class="w-100 col-12 BannerPhoto d-flex flex-lg-column justify-content-end"
          ...
          <div class="row col-12 m-0 p-0">
            ...
            <!--                >-->
            <!--&lt;!&ndash;                  <WhiteCropIcon class="ChangePhotoIcon" fill="white" style="height: 20px; width: 20px;"/>&ndash;&gt;-->
      ...
      <ul class="nav nav-pills align-items-end profile_tabs tw-overflow-x-auto px-3" id="pills-tab" role="tablist" style="z-index: 99;">
        ...
        <li class="nav-item" role="presentation m-0" style="margin: 0 !important;">
          <button class="nav-link active customFontSize" id="posts-home-tab" data-bs-toggle="pill" data-bs-target="#posts-home"
            ...
            <span class="d-flex" v-else-if="$route.params.slug && getUserDetails && getUserDetails.baseData">
              ...
              <svg v-if="getUserDetails && getUserDetails.userInfo && getUserDetails.userInfo.userSetting && getUserDetails.userInfo.userSetting.isPrivatePost" xmlns="http://www.w3.org/2000/svg" class="tw-h-5 tw-w-5" viewBox="0 0 20 20" fill="red">
        ...
        <li class="nav-item" role="presentation m-0" style="margin: 0 !important;">
          <button class="nav-link customFontSize" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact"
            ...
            <span class="d-flex" v-else>
              ...
              <svg v-if="getUserDetails && getUserDetails.userInfo && getUserDetails.userInfo.userSetting && getUserDetails.userInfo.userSetting.isPrivateGalleryFriend" xmlns="http://www.w3.org/2000/svg" class="tw-h-4 tw-w-4" viewBox="0 0 20 20" fill="red">
                <path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd" />
              </svg>
            </span>
          </button>
        ...
        <li class="d-flex mb-1 align-items-end" style="margin-right: auto">
          <div class="add-btn" v-if="$route.params.slug && getUserDetails">
            ...
            <button
              ...
              style="background-color: green;color: white;font-size: 13px;align-items: center;cursor: auto"
              v-else-if="getUserDetails.followStatus === 3"
            >
              <CheckIcon class="tw-ml-2" style="width: 18px; height: 24px;"/>
              دوست من
            </button>
          </div>
          <div class="add-btn" v-if="$route.params.slug && getUserDetails ">
            <button
              ...
              style="cursor: pointer;background-color: rgb(177 0 0);color: white;font-size: 13px;align-items: center;"

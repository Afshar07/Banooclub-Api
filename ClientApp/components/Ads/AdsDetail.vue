  ...
  <div>
    ...
    <div class="custom_card">
      ...
      <div class="tw-flex tw-justify-between tw-items-center lg:tw-p-4 tw-p-2.5">
        <div class="tw-flex tw-items-center">
          <nuxt-link :to="`/user/${AdsDetail.userInfo.userId}/posts`" class="text-decoration-none">
            <img v-if="AdsDetail.userInfo.selfieFileData!==null" :src="`https://api.banooclub.simagar.com/${AdsDetail.userInfo.selfieFileData}`" alt="profile_image" class="tw-bg-gray-200 tw-border tw-border-white tw-rounded-full tw-w-10 tw-h-10">
      ...
      <vueper-slides
        ...
        >
          <template #content>
            <img v-if="slide.priority == 1 || slide.priority == 2" class="tw-w-full tw-h-full" :src="`https://api.banooclub.simagar.com/${slide.base64}`" :alt="AdsDetail.title"
            ...
            <video
              ...
              controls
              :src="`https://api.banooclub.simagar.com/${slide.base64}`"
            ></video>
          </template>
        </vueper-slide>
      </vueper-slides>
      <vueper-slides
        ...
        <vueper-slide
          ...
          <template #content>
            <img v-if="slide.priority == 1 || slide.priority == 2" class=" tw-w-full" :src="`https://api.banooclub.simagar.com/${slide.base64}`" :alt="AdsDetail.title" style="object-fit: cover;object-position: center !important; height: 100px;">

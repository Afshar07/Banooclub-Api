<template>
  <div class="card tw-w-full" v-if="AdsDetail" @click="$router.push(`/Migration/AdvertiseDetail/${AdsDetail.adsId}`)">
    <div
      ...
      <nuxt-link v-if="AdsDetail.userInfo && AdsDetail.userInfo.selfieFileData"
        ...
        <img
          class="headerPicture"
          :src="`https://subapi.banoclub.com/${AdsDetail.userInfo.selfieFileData}`"
          alt=""
    ...
    <div class="cardImage tw-relative">
      ...
      <img v-if="AdsDetail.photos && AdsDetail.photos.length>0" class="tw-w-full tw-h-[7rem] tw-object-cover"
           :src="`https://subapi.banoclub.com/${AdsDetail.photos[0].base64}`" :alt="AdsDetail.title">

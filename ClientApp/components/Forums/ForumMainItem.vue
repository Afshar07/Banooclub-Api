<template>
  <div class="tw-flex tw-items-start tw-p-7 mx-auto">
    ...
    <div class="tw-flex tw-flex-col tw-items-center ">
      ...
      <img v-else-if="forum_details.userInfo " :src="`https://banooclubapi.oregonserver.com/media/gallery/profile/${forum_details.userInfo.selfieFileData}`" alt="" class="tw-w-12 tw-h-12 tw-rounded-full">
      <br>

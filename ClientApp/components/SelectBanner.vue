...
<template>
  <div class="col-md-12">
    ...
    <div class="tw-w-full ">
      <img  :src="`/DefaultBanners/${SelectedBanner}`" class="tw-w-full tw-h-20 tw-rounded tw-object-cover" alt="">
      ...
      <div  @click="SendBannerName" class="tw-w-full my-2 tw-flex tw-items-center tw-justify-center">

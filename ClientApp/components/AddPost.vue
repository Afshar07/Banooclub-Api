<template>
  <div>
            ...
            <div class="row" style="overflow-y: scroll;">
              ...
              <div class="col-xl-4 col-md-6 col-12 my-3 d-flex justify-content-center" v-for="(item,index) in galleries"
                ...
                <img v-if="item.priority === 2" @click.stop="selectImage(item)"
                     :src="`https://api.banooclub.simagar.com/media/gallery/galleryimages/${item.base64}`"
            ...
            <div class="row" style="overflow-y: scroll;">
              <div class="col-xl-4 col-md-6 col-12 my-3 d-flex justify-content-center"
                ...
                <img v-if="media.blob === '' && media.priority===2"
                     :src="`https://api.banooclub.simagar.com/media/gallery/galleryimages/${media.base64}`"
                     class="rounded posts_media_size" alt="post_image"/>
                <video
                  ...
                  controls
                  :autoplay="false"
                  :src="`https://api.banooclub.simagar.com/media/gallery/galleryvideos/${media.base64}`"
                ></video>
    ...
    <div class="tw-flex tw-items-center tw-shadow tw-justify-between bg-white tw-rounded gap-2 p-3" style="border-radius: 8px!important;">
      <img src="/girl-icon-post.png" class="tw-w-[6rem] tw-h-20" alt="">

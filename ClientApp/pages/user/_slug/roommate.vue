            ...
            <div class="col-md-12">
              <client-only>
                ...
                >
                  <swiper-slide
                    class="slide-1"
                    v-for="(item,idx) in roomateData.photos"
                    :key="idx"
                  >
                    <img
  ...
  <div v-else-if="!$fetchState.pending && !roomateData" class="container-fluid bg-white pt-5">
    <p class="text-center">این کاربر اطلاعاتی برای هم خانه وارد نکرده است.</p>
  </div>
</template>

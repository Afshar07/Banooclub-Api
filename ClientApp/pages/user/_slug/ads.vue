  ...
  <div class="container-fluid">
    ...
    >
            ...
            <div class="row bg-white AdCard border rounded">
              <div class="col-md-6 pt-4">
                ...
                <div class="d-flex align-items-center gap-2">
                  ...
                  <small class="text-primary tw-cursor-pointer" @click="goToUserProfile(item.userInfo)" style="font-size: 12px">{{
      ...
      <div v-else class="container-fluid bg-white">
        <p class="text-center py-4">این کاربر آگهی ثبت نکرده است</p>
      </div>
    </div>
